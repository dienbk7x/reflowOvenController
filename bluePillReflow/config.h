...
static const uint8_t PIN_LCD_RST  = PB0;
static const uint8_t LCD_ROTATION = 1; // 0/2-> portrait, 1/3-> landscape
...
static const char PIN_TC_DO     = PA6;
static const char PIN_TC_CLK    = PA5;
static const char PIN_FAN       = PA8; //
static const char PIN_HEATER    = PA9; //
static const char PIN_BEEPER    = PB9; // Beeper Out
// --- encoder
static const char PIN_ENC_A     = PA0; //
static const char PIN_ENC_B     = PA1; //
static const char PIN_ENC_BTN   = PA2; //
